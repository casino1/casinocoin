...
bool ProcessBlockFound(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    if (!ProcessNewBlock(state, NULL, pblock))
        return error("CasinoCoinMiner : ProcessNewBlock, block not accepted");
...
{
    LogPrintf("CasinoCoinMiner started\n");
    ...
    while (fGenerateBitcoins || fProofOfStake) {
        ...
        LogPrintf("Running CasinoCoinMiner with %u transactions in block (%u bytes)\n", pblock->vtx.size(),
