...
{
public:
    /// Is the inputs associated with this public key? (and there is 10000 CANO - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of casinocoin.
