...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("CasinoCoin Core"),
     ...
     * override -datadir in the casinocoin.conf file in the default data directory
     * (to be consistent with casinocoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
