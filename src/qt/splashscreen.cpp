...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("CasinoCoin Core");
	...
	QString copyrightTextCano = QChar(0xA9) + QString(tr(" 2018 The CasinoCoin Core developers"));
    ...
    pixPaint.setPen(QColor(234, 170, 0));
	...
	pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextCano);
