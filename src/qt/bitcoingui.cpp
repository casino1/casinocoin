                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CasinoCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and casinocoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CasinoCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about CasinoCoin Core"));
    ...
    openAction->setStatusTip(tr("Open a CasinoCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CasinoCoin Core help message to get a list with possible CasinoCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CasinoCoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("CasinoCoin Core"); // default title
