...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Casinocoin Core casinocoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  casinocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded casinocoin transaction") + "\n" +
                               "  casinocoin-tx [options] -create [commands]   " + _("Create hex-encoded casinocoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded casinocoin transaction
