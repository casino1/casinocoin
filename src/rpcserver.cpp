...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Casinocoin features */
        {"casinocoin", "masternode", &masternode, true, true, false},
        {"casinocoin", "listmasternodes", &listmasternodes, true, true, false},
        {"casinocoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"casinocoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"casinocoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"casinocoin", "masternodedebug", &masternodedebug, true, true, false},
        {"casinocoin", "startmasternode", &startmasternode, true, true, false},
        {"casinocoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"casinocoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"casinocoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"casinocoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"casinocoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"casinocoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"casinocoin", "mnbudget", &mnbudget, true, true, false},
        {"casinocoin", "preparebudget", &preparebudget, true, true, false},
        {"casinocoin", "submitbudget", &submitbudget, true, true, false},
        {"casinocoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"casinocoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"casinocoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"casinocoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"casinocoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"casinocoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"casinocoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"casinocoin", "checkbudgets", &checkbudgets, true, true, false},
        {"casinocoin", "mnsync", &mnsync, true, true, false},
        {"casinocoin", "spork", &spork, true, true, false},
        {"casinocoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"casinocoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use casinocoind, or the -server option to casinocoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> casinocoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1: 7338/\n";
}
