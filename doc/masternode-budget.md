...
Casinocoin now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<casinocoin_address\> \<monthly_payment_casinocoin\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ CasinoCoin, _12_ times over the course of a year totaling _24000_ CasinoCoin.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<casinocoin_address\> \<monthly_payment_casinocoin\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` CasinoCoin.
