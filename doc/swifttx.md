...
This mechanism has been integrated into Bitcore-Node-CasinoCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/CasinoCoin-Project/insight-api-casinocoin#web-socket-api](https://github.com/CasinoCoin-Project/insight-api-casinocoin#web-socket-api) 
* API: [https://github.com/CasinoCoin-Project/insight-api-casinocoin#swifttx-transactions](https://github.com/CasinoCoin-Project/insight-api-casinocoin#swifttx-transactions) 
...
By default, the CasinoCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the CasinoCoin Core daemon:
