...
In order to support loading of multiple wallets in casinocoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is casinocoin.cpp.
...
Changes to casinocoin.cpp
----------------------
casinocoin.cpp is the entry point into casinocoin-qt, and as such, will require some minor modifications to provide hooks for
