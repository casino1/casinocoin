...
Run CasinoCoin behind a Tor proxy
----------------------------------
...
```
./casinocoind -onion=127.0.0.1:9050 -onlynet=tor -listen=0 -addnode=dnetzj6l4cvo2fxy.onion:989
```
...
Run a CasinoCoin hidden server
-------------------------------
...
your casinocoind's P2P listen port ( 7337 by default).
```
...
```
./casinocoind -proxy=127.0.0.1:9050 -externalip=dnetzj6l4cvo2fxy.onion:989 -listen
```
...
```
./casinocoind -onion=127.0.0.1:9050 -externalip=dnetzj6l4cvo2fxy.onion:989 -discover
```

List of known CasinoCoin Tor relays
------------------------------------
```
